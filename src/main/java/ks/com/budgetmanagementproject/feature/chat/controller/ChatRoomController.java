...
public class ChatRoomController {
    ...
    public ResponseEntity<?> createRoom(
        ...
        ChatRoomResponse response = chatRoomService.createRoom(request, user);

        return ResponseEntity
                .status(BaseResponseStatus.CHATROOM_CREATE_SUCCESS.getStatus())
                .body(BaseResponse.of(BaseResponseStatus.CHATROOM_CREATE_SUCCESS, response));
    }
    ...
    public ResponseEntity<?> getRoomList() {
        ...
        List<ChatRoomResponse> rooms = chatRoomService.getRoomList();

        return ResponseEntity
                .status(BaseResponseStatus.CHATROOM_LIST_SUCCESS.getStatus())
                .body(BaseResponse.of(BaseResponseStatus.CHATROOM_LIST_SUCCESS, rooms));
    }
    ...
    public ResponseEntity<?> getRoomDetail(@PathVariable Long roomId) {
        ...
        RoomDetailResponse detail = chatRoomService.getRoomDetail(roomId);

        return ResponseEntity
                .status(BaseResponseStatus.CHATROOM_DETAIL_SUCCESS.getStatus())
                .body(BaseResponse.of(BaseResponseStatus.CHATROOM_DETAIL_SUCCESS, detail));
    }
